...
// ******* scenario javascript ********************************
router.get('/v8/scenario', function (req, res) {
  // Set URl
  res.render('v8/scenario', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/scenario', function (req, res) {
  res.redirect('/v8/search-register')
})


// ******* Sign-in javascript ********************************
router.get('/v8/sign-in', function (req, res) {
  // Set URl
  res.render('v8/sign-in', {
    currentUrl: req.originalUrl
  })
})
...
router.post('/v8/sign-in', function (req, res) {
  ...
  if (req.session.data['email'] === '') {
    ...
    res.render('v8/sign-in', {
      ...
      res.redirect('/v8/search-signed-in')
    }
})


// ******* authcode javascript ********************************
router.get('/v8/auth-code', function (req, res) {
  // Set URl
  res.render('v8/auth-code', {
    currentUrl: req.originalUrl
  })
})
...
router.post('/v8/auth-code', function (req, res) {
  ...
  if (req.session.data['authCode'] === '') {
    ...
    res.render('v8/auth-code', {
      ...
      res.redirect('/v8/chs-file-accounts')
    }
})
...
router.get('/v8/chs-presenter-type', function (req, res) {
  // Set URl
  res.render('v8/chs-presenter-type', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/chs-presenter-type', function (req, res) {
  // Create empty array
  var errors = []
...
router.get('/v8/chs-presenter-statements', function (req, res) {
  // Set URl
  res.render('v8/chs-presenter-statements', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/chs-presenter-statements', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['statements'] === 'undefined') {
    ...
    res.render('v8/chs-presenter-statements', {
      ...
      res.redirect('/v8/change-address')
  }
})


// ******* have-you-verified javascript ********************************
router.get('/v8/have-you-verified', function (req, res) {
  // Set URl
  res.render('v8/have-you-verified', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/have-you-verified', function (req, res) {
  // Create empty array
  var errors = []
  ...
  if (typeof req.session.data['haveVerified'] === 'undefined') {
    ...
    if (req.session.data['haveVerified'] === 'yes') {
      res.redirect('/v8/verified-details')
    } else {
      // User inputted value so move to next page
      res.redirect('/v8/verify-your-identity')
    }
  }
})
...
router.get('/v8/verified-details', function (req, res) {
  // Set URl
  res.render('v8/verified-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v8/verified-details', function (req, res) {
  // Create empty array and set error variables to false
  var errors = []
  ...
  if (detailsError) {
    ...
    res.redirect('/v8/binding-fail-locked')
  } else {
    // User inputted value so move to next page
    res.redirect('/v8/binding-success')
  }
})
