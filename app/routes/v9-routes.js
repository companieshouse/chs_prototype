...
// ******* scenario javascript ********************************
router.get('/v9/scenario', function (req, res) {
  // Set URl
  res.render('v9/scenario', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/scenario', function (req, res) {
  res.redirect('/v9/search-register')
})


// ******* Sign-in javascript ********************************
router.get('/v9/sign-in', function (req, res) {
  // Set URl
...
// ******* authcode javascript ********************************
router.get('/v9/auth-code', function (req, res) {
  // Set URl
...
router.get('/v9/chs-presenter-type', function (req, res) {
  // Set URl
...
router.get('/v9/chs-presenter-statements', function (req, res) {
  // Set URl
...
router.get('/v9/have-you-verified', function (req, res) {
  // Set URl
...
router.get('/v9/verified-details', function (req, res) {
  // Set URl
  res.render('v9/verified-details', {
    currentUrl: req.originalUrl
  })
})

router.post('/v9/verified-details', function (req, res) {
  // Create empty array and set error variables to false
  var errors = []
  ...
  if (detailsError) {
    ...
    res.redirect('/v9/binding-fail-locked')
  } else {
    // User inputted value so move to next page
    res.redirect('/v9/binding-success')
  }
})
